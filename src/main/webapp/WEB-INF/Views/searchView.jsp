...
<jsp:include page="../../header.jsp" />
   ...
   <div class="container">
      <div class="form-group row pull-right">
         ...
         <div class='col-xs-8'>
			<input class="form-control" type="text" id="searchText" onkeyup="searchFunction()" size="20" placeholder="검색어를 입력해주세요" style="padding: 11px; border: 1px solid rgb(23, 28, 94); border-radius: 5px px 5px 5px;">         </div>
         <div class="col-xs-2">
